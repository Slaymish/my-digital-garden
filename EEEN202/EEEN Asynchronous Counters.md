...
- Every bit in the counter output code is the output from one sequential element ([[EEEN_Clocks#^b9278f\|FF]]). These bits do not all change at the same time (not synchronised)
